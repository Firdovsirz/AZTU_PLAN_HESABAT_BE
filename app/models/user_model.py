...
class User(Base):
    ...
    faculty_code = Column(String, ForeignKey("faculty.faculty_code"), nullable=True)
    cafedra_code = Column(String, ForeignKey("cafedras.cafedra_code"))
    department_code = Column(String, ForeignKey("departments.department_code"), nullable=True)
